...
const thisMonthJsonObject = (year, monthNumber) => {
...
const thisMonthJsonObjectFromMondayToSunday = (year, monthNumber) => {
  return getFromMonday(getToSunday(thisMonthJsonObject(year, monthNumber)));
};

module.exports = thisMonthJsonObjectFromMondayToSunday;
